import{_ as b,a as f}from"./index.b60dd402.js";/* empty css                                                                 */import{C as S}from"./CustomizedButton.be7ca9c5.js";import{r as g,s as r,B as x,o as v,c as D,a as t,C as _,v as O,x as B,D as u,y as T,F as P,f as h,g as m,w as y,E as C,G as k,j as M,t as w,i as A,H as E,e as I}from"./vendor.54853348.js";const L={name:"ModalOverlay",props:{opened:{type:Boolean,default:!1},backable:{type:Boolean,default:!1},height:{type:String,default:"400"},width:{type:String,default:"400"}},emits:["back-screen"],setup(o,{emit:n}){let a=g({status:o.opened}),e=r(()=>`height: ${o.height}px; 
      width: ${o.width}px; 
      top: calc(50% - ${o.height/2}px); 
      left: calc(50% - ${o.width/2}px);`);const d=()=>{new Promise(l=>{l()}).then(()=>{setTimeout(()=>{a.status=!a.status},10)})},s=()=>{n("back-screen")};return x(()=>o.opened,()=>{d()}),{modalOpened:a,modalStyle:e,toggleModal:d,backScreen:s}}},N={class:"control-bar"},V={class:"modal-body-container"};function j(o,n,a,e,d,s){return v(),D(P,null,[t("div",{class:_(["modal-overlay-shade",e.modalOpened.status?"opened":""]),onClick:n[0]||(n[0]=l=>e.toggleModal())},null,2),t("div",{class:_(["modal-overlay-wrapper",e.modalOpened.status?"opened":""]),style:T(e.modalStyle)},[t("div",N,[O(t("div",{class:"icon-back",onClick:n[1]||(n[1]=l=>e.backScreen())},null,512),[[B,a.backable]]),t("div",{class:"icon-close",onClick:n[2]||(n[2]=l=>e.toggleModal())})]),t("div",V,[t("h4",null,[u(o.$slots,"title",{},void 0,!0)]),t("div",null,[u(o.$slots,"content",{},void 0,!0)]),t("div",null,[u(o.$slots,"customComponent",{},void 0,!0)])])],6)],64)}var z=b(L,[["render",j],["__scopeId","data-v-d25a8804"]]);const R={name:"ModalOverlayDemo",components:{ModalOverlay:z,CustomizedButton:S},setup(){let o=g({title:"Default modal Title",content:"Default modal Content"}),n=g({components:[{}]});const a=()=>{n.components=[{}],o.title=null,o.content=null,o.height=void 0,o.width=void 0,o.opened=!o.opened},e=()=>{a(),o.title="Modal Title",o.content="Modal Content"},d=()=>{a(),o.height="400",o.width="600",n.components.unshift({key:"dummy-component-2",component:C(k(()=>f(()=>import("./DynamicLoadDummy-2.5f0159f5.js"),["assets/DynamicLoadDummy-2.5f0159f5.js","assets/DynamicLoadDummy-2.f617a68e.css","assets/index.b60dd402.js","assets/index.55543177.css","assets/vendor.54853348.js"])))})},s=()=>{n.components.unshift({key:"dummy-component-1",component:C(k(()=>f(()=>import("./DynamicLoadDummy-1.ed415aa0.js"),["assets/DynamicLoadDummy-1.ed415aa0.js","assets/index.b60dd402.js","assets/index.55543177.css","assets/vendor.54853348.js"])))})},l=()=>{n.components.shift()},i=r(()=>`
<ModalOverlay
