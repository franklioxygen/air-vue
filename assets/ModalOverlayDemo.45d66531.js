import{_ as b,a as g}from"./index.4082a964.js";import{r as _,s as r,B as S,o as v,c as D,a as t,C as f,v as x,x as O,D as u,y as B,F as P,f as h,g as m,w as y,E as C,G as k,j as M,t as w,i as T,H as A,e as E}from"./vendor.54853348.js";import{C as I}from"./CustomizedButton.6eb61ff8.js";const L={name:"ModalOverlay",props:{opened:{type:Boolean,default:!1},backable:{type:Boolean,default:!1},height:{type:String,default:"400"},width:{type:String,default:"400"}},emits:["back-screen"],setup(o,{emit:n}){let a=_({status:o.opened}),e=r(()=>`height: ${o.height}px; 
      width: ${o.width}px; 
