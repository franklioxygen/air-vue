import{_ as p}from"./index.44d55d6b.js";import"./deviceType.f861e0a5.js";import{s as u,o as l,c as a,a as r,y as _,F as y,h as f,C as h,t as P,e as m,p as B,b as x,r as S,d as C,f as v,g as i}from"./vendor.54853348.js";const b={name:"ProgressBar",props:{currentProgress:{type:Number,default:0,required:!0},textPosition:{type:String,default:""},sections:{type:Array,default:()=>[]}},setup(t){const d=u(()=>t.currentProgress!==null?`width: ${t.currentProgress}%;`:""),e=u(()=>t.currentProgress!==null?`left:${t.currentProgress}% `:"");return{liquidStyle:d,ballStyle:e,sectionDotStyle:n=>{if(n!==0&&n!==t.sections.length-1)return`left: ${100*(n/(t.sections.length-1))}%;`},sectionStyle:n=>{if(n!==0&&n!==t.sections.length-1)return`left: ${100*(n/(t.sections.length-1))}%;`}}}},k=t=>(B("data-v-78cd01dd"),t=t(),x(),t),D={class:"progress-wrapper"},I=k(()=>r("div",{class:"tube"},null,-1)),T={class:"section-indicator"},j={key:0,class:"section-names"};function q(t,d,e,s,g,n){return l(),a("div",D,[I,r("div",{class:"liquid",style:_(s.liquidStyle)},null,4),r("div",T,[(l(!0),a(y,null,f(e.sections,(c,o)=>(l(),a("div",{key:o,style:_(s.sectionDotStyle(o)),class:h(["section-dot",o===e.sections.length-1?"last":"",o===0?"first":"",e.currentProgress/100>o/e.sections.length?"passed":""])},null,6))),128))]),e.sections.length!==0?(l(),a("ul",j,[(l(!0),a(y,null,f(e.sections,(c,o)=>(l(),a("li",{key:o,style:_(s.sectionStyle(o)),class:h([o===e.sections.length-1?"last":"",o===0?"first":""])},P(c),7))),128))])):m("",!0),r("div",{class:"ball",style:_(s.ballStyle)},[e.textPosition==="float-text"&&e.sections.length===0?(l(),a("div",{key:0,class:h(["text-percentage",e.textPosition])},P(e.currentProgress)+"% ",3)):m("",!0)],4),e.textPosition==="fixed-text"&&e.sections.length===0?(l(),a("div",{key:1,class:h(["text-percentage",e.textPosition])},P(e.currentProgress)+"% ",3)):m("",!0)])}var w=p(b,[["render",q],["__scopeId","data-v-78cd01dd"]]);const N={name:"ProgressBarDemo",components:{ProgressBar:w},setup(){const t=u(()=>`
<!-- normal progress bar -->
