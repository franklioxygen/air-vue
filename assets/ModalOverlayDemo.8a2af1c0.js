import{_ as w,a as _}from"./index.14e09776.js";import{r as h,s as i,B as S,o as y,c as P,a as n,C as g,v as O,x,D as p,y as T,F as b,f as v,g as c,w as u,E as f,G as C,j as k,t as M,i as B,H as A,e as E}from"./vendor.ebe7cf86.js";const I={name:"ModalOverlay",props:{opened:{type:Boolean,default:!1},backable:{type:Boolean,default:!1},height:{type:String,default:"300"},width:{type:String,default:"300"}},emits:["back-screen"],setup(o,{emit:t}){let a=h({status:o.opened}),e=i(()=>`height: ${o.height}px; 
      width: ${o.width}px; 
      top: calc(50% - ${o.height/2}px); 
      left: calc(50% - ${o.width/2}px);`);const d=()=>{new Promise(l=>{l()}).then(()=>{new Promise(l=>{setTimeout(()=>{a.status=!a.status,l()},10)})})},m=()=>{t("back-screen")};return S(()=>o.opened,()=>{d()}),{modalOpened:a,modalStyle:e,toggleModal:d,backScreen:m}}},L={class:"control-bar"},N={class:"modal-body-container"};function V(o,t,a,e,d,m){return y(),P(b,null,[n("div",{class:g(["modal-overlay-shade",e.modalOpened.status?"opened":""]),onClick:t[0]||(t[0]=l=>e.toggleModal())},null,2),n("div",{class:g(["modal-overlay-wrapper",e.modalOpened.status?"opened":""]),style:T(e.modalStyle)},[n("div",L,[O(n("div",{class:"icon-back",onClick:t[1]||(t[1]=l=>e.backScreen())},null,512),[[x,a.backable]]),n("div",{class:"icon-close",onClick:t[2]||(t[2]=l=>e.toggleModal())})]),n("div",N,[n("h4",null,[p(o.$slots,"title",{},void 0,!0)]),n("div",null,[p(o.$slots,"content",{},void 0,!0)]),n("div",null,[p(o.$slots,"customComponent",{},void 0,!0)])])],6)],64)}var j=w(I,[["render",V],["__scopeId","data-v-7973f724"]]);const R={name:"ModalOverlayDemo",components:{ModalOverlay:j},setup(){let o=h({title:"Default modal Title",content:"Default modal Content"}),t=h({components:[{}]});const a=()=>{t.components=[{}],o.title=null,o.content=null,o.height=void 0,o.width=void 0,o.opened=!o.opened},e=()=>{a(),o.title="Modal Title",o.content="Modal Content",o.height="400",o.width="500"},d=()=>{a(),t.components.unshift({key:"dummy-component-2",component:f(C(()=>_(()=>import("./DynamicLoadDummy-2.bd874c6b.js"),["assets/DynamicLoadDummy-2.bd874c6b.js","assets/DynamicLoadDummy-2.1280577f.css","assets/index.14e09776.js","assets/index.bd7f0766.css","assets/vendor.ebe7cf86.js"])))})},m=()=>{t.components.unshift({key:"dummy-component-1",component:f(C(()=>_(()=>import("./DynamicLoadDummy-1.73543b44.js"),["assets/DynamicLoadDummy-1.73543b44.js","assets/index.14e09776.js","assets/index.bd7f0766.css","assets/vendor.ebe7cf86.js"])))})},l=()=>{t.components.shift()},s=i(()=>`
<ModalOverlay
