...
const popSuccessMessage = () => {
    ...
    messageProps.content = "This is a Success Message.";
      ...
      `);return{messageProps:n,insertCode:i,importCode:g,templateCode:c,exampleInlineMessage:e,popSuccessMessage:o,popWarningMessage:s,popFailedMessage:l,popInfoMessage:r}}},w=t("h3",null,"Inline Message",-1),k=t("p",null,"Inline Message is to display message to user.",-1),T=t("h5",null,"Demo:",-1),F={class:"demo-wrapper"},j=t("h5",null,"Usage:",-1),D=t("h6",null,"Insert component:",-1),V=t("h6",null,"Import:",-1),z=t("h6",null,"Apply in template\uFF1A",-1);function N(n,e,o,s,l,r){const i=u("CustomizedButton"),g=u("InlineMessage"),c=u("highlightjs");return v(),x(C,null,[w,k,T,t("div",F,[a(i,{"button-text":"Success Message",width:"200px",level:"av-btn-primary",onClickButton:e[0]||(e[0]=d=>s.popSuccessMessage())}),a(i,{"button-text":"Warning Message",width:"200px",level:"av-btn-primary",onClickButton:e[1]||(e[1]=d=>s.popWarningMessage())}),a(i,{"button-text":"Failed Message",width:"200px",level:"av-btn-primary",onClickButton:e[2]||(e[2]=d=>s.popFailedMessage())}),a(i,{"button-text":"Info Message",width:"200px",level:"av-btn-primary",onClickButton:e[3]||(e[3]=d=>s.popInfoMessage())}),a(g,{type:s.messageProps.type,content:s.messageProps.content,expanded:s.messageProps.expanded,ref:"exampleInlineMessage"},null,8,["type","content","expanded"])]),j,D,a(c,{language:"html",code:s.insertCode},null,8,["code"]),V,a(c,{language:"js",code:s.importCode},null,8,["code"]),z,a(c,{language:"js",code:s.templateCode},null,8,["code"])],64)}var L=f(S,[["render",N]]);export{L as default};
