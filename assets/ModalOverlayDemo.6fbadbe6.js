import{_ as b,a as g}from"./index.d317ea2a.js";import{r as _,s as r,B as S,o as v,c as D,a as t,C as f,v as x,x as O,D as u,y as B,F as P,f as h,g as m,w as y,E as C,G as k,j as M,t as w,i as T,H as A,e as E}from"./vendor.54853348.js";import{C as I}from"./CustomizedButton.a91e2b7b.js";const L={name:"ModalOverlay",props:{opened:{type:Boolean,default:!1},backable:{type:Boolean,default:!1},height:{type:String,default:"400"},width:{type:String,default:"400"}},emits:["back-screen"],setup(o,{emit:n}){let a=_({status:o.opened}),e=r(()=>`height: ${o.height}px; 
      width: ${o.width}px; 
      top: calc(50% - ${o.height/2}px); 
      left: calc(50% - ${o.width/2}px);`);const d=()=>{new Promise(l=>{l()}).then(()=>{new Promise(l=>{setTimeout(()=>{a.status=!a.status,l()},10)})})},s=()=>{n("back-screen")};return S(()=>o.opened,()=>{d()}),{modalOpened:a,modalStyle:e,toggleModal:d,backScreen:s}}},N={class:"control-bar"},V={class:"modal-body-container"};function j(o,n,a,e,d,s){return v(),D(P,null,[t("div",{class:f(["modal-overlay-shade",e.modalOpened.status?"opened":""]),onClick:n[0]||(n[0]=l=>e.toggleModal())},null,2),t("div",{class:f(["modal-overlay-wrapper",e.modalOpened.status?"opened":""]),style:B(e.modalStyle)},[t("div",N,[x(t("div",{class:"icon-back",onClick:n[1]||(n[1]=l=>e.backScreen())},null,512),[[O,a.backable]]),t("div",{class:"icon-close",onClick:n[2]||(n[2]=l=>e.toggleModal())})]),t("div",V,[t("h4",null,[u(o.$slots,"title",{},void 0,!0)]),t("div",null,[u(o.$slots,"content",{},void 0,!0)]),t("div",null,[u(o.$slots,"customComponent",{},void 0,!0)])])],6)],64)}var z=b(L,[["render",j],["__scopeId","data-v-1bb163b3"]]);const R={name:"ModalOverlayDemo",components:{ModalOverlay:z,CustomizedButton:I},setup(){let o=_({title:"Default modal Title",content:"Default modal Content"}),n=_({components:[{}]});const a=()=>{n.components=[{}],o.title=null,o.content=null,o.height=void 0,o.width=void 0,o.opened=!o.opened},e=()=>{a(),o.title="Modal Title",o.content="Modal Content"},d=()=>{a(),o.height="400",o.width="600",n.components.unshift({key:"dummy-component-2",component:C(k(()=>g(()=>import("./DynamicLoadDummy-2.9f84ff5e.js"),["assets/DynamicLoadDummy-2.9f84ff5e.js","assets/DynamicLoadDummy-2.1280577f.css","assets/index.d317ea2a.js","assets/index.745d1de7.css","assets/vendor.54853348.js"])))})},s=()=>{n.components.unshift({key:"dummy-component-1",component:C(k(()=>g(()=>import("./DynamicLoadDummy-1.0ce9d38b.js"),["assets/DynamicLoadDummy-1.0ce9d38b.js","assets/index.d317ea2a.js","assets/index.745d1de7.css","assets/vendor.54853348.js"])))})},l=()=>{n.components.shift()},i=r(()=>`
<ModalOverlay
