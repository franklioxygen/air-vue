import{_ as f}from"./index.5a3dee3a.js";import{o as d,c as M,F as y,h as x,a,C as p,t as h,j as C,r as w,I as F,s as _,f as v,g as i}from"./vendor.54853348.js";import{C as b}from"./CustomizedButton.3d41fd6c.js";const B={name:"ToastMessage",props:{messagesWrapper:{type:Object,default:()=>({})}},emits:["remove-msg-from-array"],setup(n,{emit:s}){const c=()=>new Promise(e=>{requestAnimationFrame(e)}),t=e=>document.querySelector(e)===null?c().then(()=>t(e)):Promise.resolve(!0);return{openMsg:e=>{t(`#${e}`).then(()=>{const r=document.getElementById(e);r.classList.add("expanded"),r.classList.remove("collapsed")})},closeMsg:e=>{s("remove-msg-from-array",e)}}}},k={class:"toast-msgs-wrapper"},D=["id"],A=["onClick"];function I(n,s,c,t,g,u){return d(),M("div",k,[(d(!0),M(y,null,x(c.messagesWrapper.messages,(e,r)=>(d(),M("div",{key:r},[a("div",{class:p(["toast-msg","collapsed",e.status]),id:e.id},[a("div",{class:p(["icons-msg","icons",e.type])},null,2),a("div",{class:p(["toast-msg-content",e.status])},[a("div",{class:p(["msg-type-name",e.type])},h(e.type),3),C(" "+h(e.content),1)],2),a("div",{class:p(["icon-close icons",e.status]),onClick:l=>t.closeMsg(e.id)},null,10,A)],10,D)]))),128))])}var W=f(B,[["render",I],["__scopeId","data-v-80dde6e2"]]);const S={name:"ToastMessageDemo",components:{ToastMessage:W,CustomizedButton:b},setup(){let n=w({messages:[]});const s=F(),c=()=>{const o="msg-"+Date.now();s.value.openMsg(o),n.messages.push({id:o,type:"success",content:`
