import{s as a,o as c,c as i,a as e,t as u,v,x as D,F as h,h as y,y as S,p as f,b as g,r as E,f as _,g as s}from"./vendor.54853348.js";import{_ as m}from"./index.68265121.js";const b={name:"DropdownSelect",props:{width:{type:String,default:""},dropdownProps:{type:Object,required:!0}},emits:["apply-dropdown"],setup(t,{emit:r}){return{dropdownStyle:a(()=>t.width!==null?`width: ${t.width}`:""),applyDropdownEmit:l=>{r("apply-dropdown",l.target.value)}}}},P=t=>(f("data-v-deb6417c"),t=t(),g(),t),x={class:"dropdown-title"},V=["value","selected"],C=P(()=>e("span",{class:"icons icon-dropdown"},null,-1));function I(t,r,n,o,l,w){return c(),i("div",{class:"dropdown-wrapper",style:S(o.dropdownStyle)},[e("span",x,u(n.dropdownProps.title),1),e("select",{class:"dropdown",onChange:r[0]||(r[0]=(...p)=>o.applyDropdownEmit&&o.applyDropdownEmit(...p))},[v(e("option",{value:"invalid",disabled:"",selected:"true"},u(n.dropdownProps.placeholder),513),[[D,n.dropdownProps.default===!1]]),(c(!0),i(h,null,y(n.dropdownProps.options,(p,d)=>(c(),i("option",{key:d,value:p.value,selected:n.dropdownProps.default===d},u(p.label),9,V))),128))],32),C],4)}var O=m(b,[["render",I],["__scopeId","data-v-deb6417c"]]);const j={name:"DropdownSelectDemo",components:{DropdownSelect:O},setup(){let t=E({returnValue:" select one"});const r=a(()=>`
<DropdownSelect
  width="200px"
