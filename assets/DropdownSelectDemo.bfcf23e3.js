...
const applyDropdown = (event) => {
  ...
  dropdownEventReturnValue.returnValue = event;
      ...
      `),l=a(()=>({title:"Demo Dropdown Title",default:!1,placeholder:"Select an option",options:[{label:"Option 1",value:1},{label:"Option 2",value:2},{label:"Option 3",value:3}]}));return{dropdownEventReturnValue:t,insertCode:d,importCode:n,templateCode:o,dropdownProps:l,applyDropdownEvent:p=>{t.returnValue=p}}}},k=e("h3",null,"Dropdown Select",-1),q=e("p",null," Dropdown Select is used to pick an option from list. It will emit and event once option picked. ",-1),A=e("h5",null,"Demo:",-1),B={class:"demo-wrapper"},R=e("h5",null,"Usage:",-1),T=e("h6",null,"Insert component:",-1),F=e("h6",null,"Import:",-1),N=e("h6",null,"Apply in template\uFF1A",-1);function z(t,d,n,o,l,w){const p=_("DropdownSelect"),r=_("highlightjs");return c(),i(h,null,[k,q,A,e("div",B,[s(p,{width:"200px","dropdown-props":o.dropdownProps,onApplyDropdown:o.applyDropdownEvent},null,8,["dropdown-props","onApplyDropdown"]),e("div",null," This is the value return from Dropdown: "+u(o.dropdownEventReturnValue.returnValue),1)]),R,T,s(r,{language:"html",code:o.insertCode},null,8,["code"]),F,s(r,{language:"js",code:o.importCode},null,8,["code"]),N,s(r,{language:"js",code:o.templateCode},null,8,["code"])],64)}var G=m(j,[["render",z]]);export{G as default};
