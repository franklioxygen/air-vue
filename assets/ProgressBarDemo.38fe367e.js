...
let progressSections = computed(() => {
    return ["Preparing", "Chopped", "Cooked", "On Table", "Eat"];
      ...
      `);let s=S({value:0});b(()=>{setInterval(function(){s.value+=10,s.value>100&&(s.value=0)},1e3)});let d=u(()=>["Preparing","Chopped","Cooked","On Table","Eat"]);return{insertCode:t,importCode:g,templateCode:e,progressSections:d,dynamicProgress:s}}},E=r("h3",null,"Progress Bar",-1),V=r("p",null,"Progress Bar is used to display progress.",-1),z=r("h5",null,"Demo:",-1),A={class:"demo-wrapper"},F=r("p",null,"This is a normal Progress Bar:",-1),M=r("p",null,"This is a float text Progress Bar:",-1),O=r("p",null,"This is a fixed text Progress Bar:",-1),L=r("p",null,"This is a sectional Progress Bar:",-1),U=r("h5",null,"Usage:",-1),G=r("h6",null,"Insert component:",-1),H=r("h6",null,"Import:",-1),J=r("h6",null,"Apply in template\uFF1A",-1);function K(t,g,e,s,d,n){const c=v("ProgressBar"),o=v("highlightjs");return l(),a(y,null,[E,V,z,r("div",A,[F,i(c,{currentProgress:80}),M,i(c,{currentProgress:60,textPosition:"float-text"}),O,i(c,{currentProgress:s.dynamicProgress.value,textPosition:"fixed-text"},null,8,["currentProgress"]),L,i(c,{currentProgress:40,sections:s.progressSections},null,8,["sections"])]),U,G,i(o,{language:"html",code:s.insertCode},null,8,["code"]),H,i(o,{language:"js",code:s.importCode},null,8,["code"]),J,i(o,{language:"js",code:s.templateCode},null,8,["code"])],64)}var W=p(N,[["render",K]]);export{W as default};
